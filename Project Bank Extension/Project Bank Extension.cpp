...
vector<string> SplitString(string S1, string Delim)
{
    ...
    while ((pos = S1.find(Delim)) != std::string::npos)
    {
        ...
        S1.erase(0, pos + Delim.length());  /* erase() until positon and move to next
       word. */
    }
    if (S1 != "")
    {
...
sUser ConvertUserLinetoRecord2(string Line, string Seperator = "#//#")
{
    sUser User;
...
vector <sUser> LoadUsersDataFromFile(string FileName)
{
    ...
    if (MyFile.is_open())
    {
        ...
        while (getline(MyFile, Line))
        {
            ...
            User = ConvertUserLinetoRecord2(Line);
...
bool FindUserByUsernameAndPassward(string Username, string Passward, sUser& User)
{
    vector <sUser> vUsers = LoadUsersDataFromFile(UsersFileName);
    for (sUser U : vUsers)
    {
        if (U.UserName == Username && U.Passward == Passward)
        {
            User = U;
            return true;
        }
...
void ShowDepsitScreen()
{
    ...
    {
        cout << "\nAmount Exceeds the balance , you can withdraw upto :" <<
...
enum enMainMenueOptions
{
    ...
    eFindClient = 5, eShowTransaction, eExit = 7
};
...
void PerfromMainMenueOption(enMainMenueOptions MainMenueOption)
{
    ...
    case enMainMenueOptions::eFindClient:
        ...
        GoBackToMainMenue();
        break;
    case enMainMenueOptions::eShowTransaction:
        system("cls");
...
void PerformTransactionsMenueOption(enTransactionsMenueOptions TransMenueOption)
{
...
void ShowTransactionsMenue()
{
    ...
    cout << "===========================================\n";
    cout << "\t[1] Deposite List.\n";
    cout << "\t[2] WithDraw Client.\n";
...
{
    if (FindUserByUsernameAndPassward(Username, Passward, CurrentUser))
        return true;
    else
        return false;
}
void Login()
{
    ...
    do
    {
        ...
        if (LoginFailed)
        {
            cout << "Invalid Username/Passward!!\n";
        }
        ...
        cout << "Enter Passward ?";
        cin >> Passward;
        LoginFailed = !LoadUserInfo(Username, Passward);
    } while (LoginFailed);
